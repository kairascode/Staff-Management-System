...
<font color='#562570'type='bold'>CONTACT<Th><font color='#562570'type='bold'>ACTION</Th></TR>";
...
"<td>".$dofa."<td>".$doca."<td>".$st."<td>".$hcounty."<td>".$contact."<td><form id='ups' method='post' action='1015.php'><input type='hidden' name='pfno' value=".$pf."/><input type='submit' value='UPDATE'></form></td></tr>"; 
 }
echo"</table>"; 
