...
if(isset($_POST['sname'])){$sname=mysql_escape_string($_POST['sname']);}

include("conn.php");

$qry=mysql_query("select*from staff where sname like'%$sname%' and status=''");
...
echo"<tr><td><b><font color='red'>HIGHEST ACADEMIC QUALIFICATION</b></font>:&nbsp".$row['hacademic']."<td colspan=1><b><font color='red'>TERMS OF SERVICE:</b></font>:&nbsp". $row['tos']."<td colspan=2><b><font color='red'>DATE ACCESSED</b></font>:$new</d></TR>";
//echo"<tr><td></td></tr>";
