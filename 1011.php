...
<body bgcolor="#CCDEDC">
<P ALIGN="center"><a href="1002.php">Home</A>&nbsp&nbsp|||&nbsp&nbsp<a href="logout.php">Logout</A>&nbsp&nbsp|||&nbsp&nbsp<input type='button' value='print Record' onClick='printDiv(cert);'/></p>
<div id="cert">
<?php
...
echo"<tr><td><b><font color='red'>HIGHEST ACADEMIC QUALIFICATION</b></font>:&nbsp".$row['hacademic']."<td colspan=1><b><font color='red'>TERMS OF SERVICE:</b></font>:&nbsp". $row['tos']."<td colspan=2><b><font color='red'>DATE PRINTED</b></font>:$new</d></TR>";
//echo"<tr><td></td></tr>";
